...
namespace CMZDedicatedLidgrenServer
{
        ...
        bool logHostMessages = false)
    {
        ...
        /// <summary>
        /// Short-lived record of the original block type reported by a player's DigMessage.
        /// </summary>
        /// <remarks>
        /// This is used by the server plugin bridge to visually restore denied mining operations
        /// when the natural/procedural block was not present in the saved terrain delta.
        /// </remarks>
        private struct RecentDigBlock
        {
            /// <summary>
            /// Raw BlockTypeEnum integer value reported by the client.
            /// </summary>
            public int BlockTypeValue;

            /// <summary>
            /// UTC timestamp used to ignore stale dig snapshots.
            /// </summary>
            ...
            Action<object, byte[], byte> sendToClient)
        {
            ...
            // These are direct client-to-host requests. The host replies and stops the outer relay.
            ...
            // These packets either update host-side state or are passed through after optional plugin checks.
        ...
        /// </summary>
        /// <remarks>
        /// The context exposes server-owned callbacks for private warnings, client-side visual correction,
        /// saved/original block lookup, and chunk resync. Returning true means a plugin consumed the packet.
        /// </remarks>
        /// <returns>
        ...
        /// </summary>
        /// <remarks>
        /// Falls back to a stable Player{senderId} label when the reflected gamer object is unavailable.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Used by RegionProtect-style plugins to warn only the offending player instead of broadcasting
        /// the denial message to every connected client.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// This does not apply terrain server-side. It only tells the denied client to correct its local view
        /// after the original mutation packet was consumed by a plugin.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// This can read modified/saved terrain entries. It cannot always know the original procedural
        /// terrain block if the block was never saved into the delta file.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// The vanilla client sends DigMessage before AlterBlockMessage, and DigMessage contains the original
        /// block type being dug. This cache lets denied mining actions visually restore natural terrain.
        /// </remarks>
