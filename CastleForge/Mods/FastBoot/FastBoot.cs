...
namespace FastBoot
{
    ...
    public class FastBoot : ModBase
    {
        /// <summary>
        /// Entrypoint for the FastBoot mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public FastBoot() : base("FastBoot", new Version("1.0.0.0"))
        {
        ...
        public override void Start()
        {
            ...
            var ns    = typeof(FastBoot).Namespace;
