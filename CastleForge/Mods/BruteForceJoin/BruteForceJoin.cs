...
namespace BruteForceJoin
{
    ...
    public class BruteForceJoin : ModBase
    {
        /// <summary>
        /// Entrypoint for the BruteForce mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public override void Start()
        {
            ...
            var ns    = typeof(BruteForceJoin).Namespace;
