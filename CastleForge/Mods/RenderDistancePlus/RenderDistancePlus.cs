...
namespace RenderDistancePlus
{
    ...
    public class RenderDistancePlus : ModBase
    {
        /// <summary>
        ...
        public RenderDistancePlus() : base("RenderDistancePlus", new Version("0.0.1.0"))
        {
        ...
        public override void Start()
        {
            ...
            var ns    = typeof(RenderDistancePlus).Namespace;
