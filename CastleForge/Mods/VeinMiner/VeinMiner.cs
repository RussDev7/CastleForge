...
namespace VeinMiner
{
    ...
    public class VeinMiner : ModBase
    {
        /// <summary>
        /// Entrypoint for the VeinMiner mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public VeinMiner() : base("VeinMiner", new Version("0.0.1.0"))
        {
        ...
        public override void Start()
        {
            ...
            var ns = typeof(VeinMiner).Namespace;
