...
namespace DedicatedServerLauncher
{
    ...
    class GamePatches
    {
        ...
        /// <summary>
        /// Prevent blocking UI dialogs in the dedicated instance.
        /// Any popup in the dedicated process is effectively a dead-end.
        /// </summary>
        internal static class DedicatedServerPatches
        {
            [HarmonyPatch(typeof(ScreenGroup), nameof(ScreenGroup.ShowPCDialogScreen),
                new Type[] { typeof(PCDialogScreen), typeof(ThreadStart) })]
            internal static class Patch_ScreenGroup_ShowPCDialogScreen_NoDedicatedDialogs
            {
                private static bool Prefix()
                {
                    return !DedicatedServerArgs.Enabled;
                }
            }

            [HarmonyPatch(typeof(ScreenGroup), nameof(ScreenGroup.ShowPCDialogScreen),
                new Type[] { typeof(PCDialogScreen), typeof(ThreadStart) })]
            internal static class Patch_ScreenGroup_ShowDialogScreen_NoDedicatedDialogs
            {
                private static bool Prefix()
                {
                    return !DedicatedServerArgs.Enabled;
