...
namespace TacticalNuke
{
    ...
    public class TacticalNuke : ModBase
    {
        /// <summary>
        /// Entrypoint for the TacticalNuke mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public TacticalNuke() : base("TacticalNuke", new Version("0.0.1.0"))
        {
        ...
        public override void Start()
        {
            ...
            var ns    = typeof(TacticalNuke).Namespace;
