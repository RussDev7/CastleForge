...
namespace PhysicsEngine
{
    ...
    public class PhysicsEngine : ModBase
    {
        /// <summary>
        /// Entrypoint for the PhysicsEngine mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public PhysicsEngine() : base("PhysicsEngine", new Version("0.0.1.0"))
        {
        ...
        public override void Start()
        {
            ...
            var ns = typeof(PhysicsEngine).Namespace;
