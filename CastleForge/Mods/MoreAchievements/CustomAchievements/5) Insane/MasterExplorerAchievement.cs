...
{
    /// <summary>
    /// "Master Explorer" - reach 65,536 distance from spawn.
    /// Uses <see cref="CastleMinerZPlayerStats.MaxDistanceTraveled"/>.
    /// </summary>
    internal sealed class MasterExplorerAchievement
        : AchievementManager<CastleMinerZPlayerStats>.Achievement,
          ILocalStatAdjust,
          IAchievementReward
    {
        public MasterExplorerAchievement(
            string apiName,
        ...
        /// <summary>
        /// Reward: TeleportGPS to get home again.
        /// </summary>
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            ModLoader.LogSystem.SendFeedback("+1 LaserDrill, +1 PrecisionLaser, +512 GoldBullets.");
        }
        #endregion
        ...
        /// <summary>
        /// On grant, ensure MaxDistanceTraveled ≥ 25,000.
