...
{
    /// <summary>
    /// Architect II (Difficulty: Normal)
    /// Place a decent number of basic building blocks.
    ///
    /// Counts ItemStats.Used for a small set of core block items
    /// (DirtBlock, RockBlock, WoodBlock, SandBlock) and unlocks once the
    /// combined total reaches RequiredPlacements.
    /// </summary>
    internal sealed class ArchitectIIAchievement
        : AchievementManager<CastleMinerZPlayerStats>.Achievement,
          ILocalStatAdjust,
          IAchievementReward
    {
        public ArchitectIIAchievement(
            string apiName,
        ...
        /// </summary>
        public const int RequiredPlacements = 1000;
        ...
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.WoodBlock, 128), false);
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.RockBlock, 64),  false);
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.IronWall,  32),  false);
            ModLoader.LogSystem.SendFeedback("+128 WoodBlock, +64 RockBlock, +32 IronWall.");
        }
        #endregion
