...
namespace MoreAchievements
{
          ...
          IAchievementReward
    {
        ...
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.Torch, 256), false);
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.Coal,  16),  false);
            ModLoader.LogSystem.SendFeedback("+256 Torch, +16 Coal.");
        }
        #endregion
