...
namespace MoreAchievements
{
          ...
          IAchievementReward
    {
        ...
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.RocketAmmo,           512), false); // Special reward (unuused ingame).
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.C4,                   64),  false);
            ModLoader.LogSystem.SendFeedback("+1 RocketLauncherGuided, +512 RocketAmmo, +64 C4.");
        }
        #endregion
