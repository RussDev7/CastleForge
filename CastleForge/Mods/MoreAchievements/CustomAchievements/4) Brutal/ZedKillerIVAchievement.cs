...
{
    /// <summary>
    /// "Zed Killer IV" - reach a massive lifetime kill count.
    /// Uses <see cref="CastleMinerZPlayerStats.TotalKills"/>.
    /// </summary>
    internal sealed class ZedKillerIVAchievement
        : AchievementManager<CastleMinerZPlayerStats>.Achievement,
          ILocalStatAdjust,
          IAchievementReward
    {
        public ZedKillerIVAchievement(
            string apiName,
        ...
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.DiamondLMGGun, 1),   false);
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.GoldBullets,   512), false);
            ModLoader.LogSystem.SendFeedback("+1 DiamondLMGGun, +512 GoldBullets.");
        }
        #endregion
        ...
        /// <summary>
        /// On grant, ensure TotalKills ≥ 10,000.
        /// On revoke, clamp to 9,999.
        /// </summary>
