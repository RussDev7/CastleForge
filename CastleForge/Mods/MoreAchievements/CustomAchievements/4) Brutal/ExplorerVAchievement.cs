...
{
    /// <summary>
    /// "Explorer V" - reach a distance of 46,340 units from spawn.
    /// Uses <see cref="CastleMinerZPlayerStats.MaxDistanceTraveled"/>.
    /// </summary>
    internal sealed class ExplorerVAchievement
        : AchievementManager<CastleMinerZPlayerStats>.Achievement,
          ILocalStatAdjust,
          IAchievementReward
    {
        public ExplorerVAchievement(
            string apiName,
        ...
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.LaserDrill,      1),   false);
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.GoldBullets,     255), false);
            ModLoader.LogSystem.SendFeedback("+3 TeleportGPS, +1 TeleportStation, +1 LaserDrill, +512 GoldBullets.");
        }
        #endregion
