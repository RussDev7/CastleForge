...
{
    /// <summary>
    /// "Explorer IV" - reach a distance of 40,000 units from spawn.
    /// Uses <see cref="CastleMinerZPlayerStats.MaxDistanceTraveled"/>.
    /// </summary>
    internal sealed class ExplorerIVAchievement
        : AchievementManager<CastleMinerZPlayerStats>.Achievement,
          ILocalStatAdjust,
          IAchievementReward
    {
        public ExplorerIVAchievement(
            string apiName,
        ...
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            ModLoader.LogSystem.SendFeedback("+2 TeleportGPS, +1 TeleportStation, +128 Torch.");
        }
        #endregion
