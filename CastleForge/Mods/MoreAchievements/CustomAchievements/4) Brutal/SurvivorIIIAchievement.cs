...
{
    /// <summary>
    /// "Survivor III" - survive 60 in-game days.
    /// Uses <see cref="CastleMinerZPlayerStats.MaxDaysSurvived"/>.
    /// </summary>
    internal sealed class SurvivorIIIAchievement
        : AchievementManager<CastleMinerZPlayerStats>.Achievement,
          ILocalStatAdjust,
          IAchievementReward
    {
        public SurvivorIIIAchievement(
            string apiName,
        ...
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.DiamondPickAxe,     1),   false);
            ...
            ModLoader.LogSystem.SendFeedback("+1 DiamondPickAxe, +1 DiamondSpade, +1 DiamondAssultRifle, +512 GoldBullets.");
        }
        #endregion
        ...
        /// <summary>
        /// On grant, ensure MaxDaysSurvived ≥ 60.
        /// On revoke, clamp to 59 or less.
        /// </summary>
