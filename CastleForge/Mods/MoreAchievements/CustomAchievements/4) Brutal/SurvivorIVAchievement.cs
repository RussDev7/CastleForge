...
{
    /// <summary>
    /// "Survivor IV" - survive 120 in-game days.
    /// Uses <see cref="CastleMinerZPlayerStats.MaxDaysSurvived"/>.
    /// </summary>
    internal sealed class SurvivorIVAchievement
        : AchievementManager<CastleMinerZPlayerStats>.Achievement,
          ILocalStatAdjust,
          IAchievementReward
    {
        public SurvivorIVAchievement(
            string apiName,
        ...
        /// <summary>
        /// Reward: a DiamondPickAxe for truly long-term survival.
        /// </summary>
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            ModLoader.LogSystem.SendFeedback("+1 BloodstonePickAxe, +1 BloodStoneAssultRifle, +512 DiamondBullets.");
        }
        ...
        /// <summary>
        /// On grant, ensure MaxDaysSurvived ≥ 120.
        /// On revoke, clamp to 119 or less.
        /// </summary>
