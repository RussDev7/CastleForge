...
namespace MoreAchievements
{
    ...
    /// </summary>
    internal sealed class ArchitectIAchievement
        : AchievementManager<CastleMinerZPlayerStats>.Achievement,
          ILocalStatAdjust,
          IAchievementReward
    {
        public ArchitectIAchievement(
            string apiName,
        ...
        /// </summary>
        public const int RequiredPlacements = 100;
        ...
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.RockBlock, 32), false);

            ModLoader.LogSystem.SendFeedback("+64 WoodBlock, +32 RockBlock.");
        }
        #endregion
