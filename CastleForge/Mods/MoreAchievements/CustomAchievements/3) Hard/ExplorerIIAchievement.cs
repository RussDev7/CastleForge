...
{
    /// <summary>
    /// "Explorer II" - reach a distance of 10,000 units from spawn.
    /// Uses <see cref="CastleMinerZPlayerStats.MaxDistanceTraveled"/>.
    /// </summary>
    internal sealed class ExplorerIIAchievement
        : AchievementManager<CastleMinerZPlayerStats>.Achievement,
          ILocalStatAdjust,
          IAchievementReward
    {
        public ExplorerIIAchievement(
            string apiName,
        ...
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            ModLoader.LogSystem.SendFeedback("+1 TeleportGPS, +1 GPS, +64 Torch.");
        }
        #endregion
