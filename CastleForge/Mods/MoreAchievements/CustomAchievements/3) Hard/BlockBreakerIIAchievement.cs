...
{
    /// <summary>
    /// "Block Breaker II" - dig a combined total of 5,000 blocks across all block types.
    /// Uses <see cref="CastleMinerZPlayerStats.BlocksDugCount(BlockTypeEnum)"/> summed across all types.
    /// </summary>
    internal sealed class BlockBreakerIIAchievement
        : AchievementManager<CastleMinerZPlayerStats>.Achievement,
          ILocalStatAdjust,
          IAchievementReward
    {
        public BlockBreakerIIAchievement(
            string apiName,
        ...
        private const int RequiredBlocks = 5000;
        ...
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.C4,          16), false);
            ModLoader.LogSystem.SendFeedback("+1 IronPickAxe, +32 TNT, +16 C4.");
        }
        #endregion
