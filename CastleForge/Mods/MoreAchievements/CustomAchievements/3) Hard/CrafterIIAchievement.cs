...
namespace MoreAchievements
{
          ...
          IAchievementReward
    {
        ...
        /// <summary>
        /// Reward: a mix of high-tier resources for building.
        /// </summary>
        public void GrantReward(CastleMinerZPlayerStats stats)
        {
            ...
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.Diamond, 32), false);
            inv.AddInventoryItem(InventoryItem.CreateItem(InventoryItemIDs.Gold,    64), false);
            ModLoader.LogSystem.SendFeedback("+32 Diamond, +64 Gold.");
        }
        #endregion
        ...
        /// On revoke, hard-reset the total to 0 to avoid Steam's partial-decrease issues.
        /// </summary>
