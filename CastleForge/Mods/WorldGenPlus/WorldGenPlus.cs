...
namespace WorldGenPlus
{
    ...
    public class WorldGenPlus : ModBase
    {
        /// <summary>
        /// Entrypoint for the WorldGenPlus mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public WorldGenPlus() : base("WorldGenPlus", new Version("0.0.1.0"))
        {
        ...
        public override void Start()
        {
            ...
            var ns    = typeof(WorldGenPlus).Namespace;
