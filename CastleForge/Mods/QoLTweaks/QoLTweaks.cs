...
namespace QoLTweaks
{
    ...
    {
        /// <summary>
        /// Entrypoint for the QoLTweaks mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public QoLTweaks() : base("QoLTweaks", new Version("0.0.1.0"))
        {
        ...
        public override void Start()
        {
            ...
            var ns    = typeof(QoLTweaks).Namespace;
