...
namespace LanternLandMap
{
    ...
    public class LanternLandMap : ModBase
    {
        /// <summary>
        /// Entrypoint for the ProjectLanternLand mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public LanternLandMap() : base("ProjectLanternLand", new Version("0.0.1.0"))
        {
        ...
        public override void Start()
        {
            ...
            var ns    = typeof(LanternLandMap).Namespace;
