...
{
    /// <summary>
    /// WorldGenPlus surface resolution helpers (rings / square bands / random regions).
            ...
            try
            {
                ...
                for (int i = 0; i < ends.Count; i++)
                {
                    ...
                    if (IsDecentBiomeType(aType))
                    {
                        ...
                        list.Add(new LanternLandMapScreen.BiomeBand(coreStart, coreEnd, c, c, false));
                        coreStart = coreEnd;
                        continue;
                    }
                    ...
                    list.Add(new LanternLandMapScreen.BiomeBand(coreStart, coreEnd, aC, aC, false));
                    ...
                    if (i + 1 < ends.Count)
                    {
                        ...
                        if (IsDecentBiomeType(bType))
                        {
                            ...
                            list.Add(new LanternLandMapScreen.BiomeBand(coreEnd, nextEnd, dC, dC, false));
                            coreStart = nextEnd;
                        ...
                        if (wHere > 0.0)
                        {
                            ...
                            list.Add(new LanternLandMapScreen.BiomeBand(coreEnd, coreEnd + wHere, aC, bC, true));
                ...
                if (coreStart < period)
                {
                    ...
                    list.Add(new LanternLandMapScreen.BiomeBand(coreStart, period, c, c, false));
                }
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    ...
                    if (e > s + 1e-9)
                        finalList.Add(new LanternLandMapScreen.BiomeBand(s, e, b.ColorA, b.ColorB, b.IsBlend));
                }
