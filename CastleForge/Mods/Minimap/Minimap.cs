...
namespace Minimap
{
    ...
    public class Minimap : ModBase
    {
        /// <summary>
        /// Entrypoint for the Minimap mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public Minimap() : base("Minimap", new Version("0.0.1.0"))
        {
        ...
        public override void Start()
        {
            ...
            var ns    = typeof(Minimap).Namespace;
