...
{
    /// <summary>
    /// Represents a single biome band in "effective distance" space, optionally blended.
    /// </summary>
    internal readonly struct BiomeBand
    {
    ...
    /// Summary: Mirrors WorldGenPlus "surface rules" so Minimap can preview biomes correctly.
    /// </summary>
    /// <remarks>
    /// Notes:
    ...
    internal static class WorldGenPlusSurfaceRules
    {
        ...
        public static bool TryBuildWorldGenPlusBands(
            ...
            int patternIndex,
            byte alpha,
            out BiomeBand[] bands) // <-- If BiomeBand is nested; otherwise change type.
        {
            bands = null;
            ...
            try
            {
                ...
                if (WorldGenPlusMath.IsSingleSurfaceMode(surfaceMode))
                {
                    ...
                    bands = new[]
                    {
                        new BiomeBand(0.0, period, c, c, false)
                    };
                ...
                var list = new List<BiomeBand>(ends.Count * 2);
                ...
                for (int i = 0; i < ends.Count; i++)
                {
                    ...
                    if (IsDecentBiomeType(aType))
                    {
                        ...
                        list.Add(new BiomeBand(coreStart, coreEnd, c, c, false));
                        coreStart = coreEnd;
                        continue;
                    }
                    ...
                    list.Add(new BiomeBand(coreStart, coreEnd, aC, aC, false));
                    ...
                    if (i + 1 < ends.Count)
                    {
                        ...
                        if (IsDecentBiomeType(bType))
                        {
                            ...
                            list.Add(new BiomeBand(coreEnd, nextEnd, dC, dC, false));
                            coreStart = nextEnd;
                        ...
                        if (wHere > 0.0)
                        {
                            ...
                            list.Add(new BiomeBand(coreEnd, coreEnd + wHere, aC, bC, true));
                ...
                if (coreStart < period)
                {
                    ...
                    list.Add(new BiomeBand(coreStart, period, c, c, false));
                }

                // Clamp.
                var finalList = new List<BiomeBand>(list.Count);
                for (int i = 0; i < list.Count; i++)
                {
                    ...
                    if (e > s + 1e-9)
                        finalList.Add(new BiomeBand(s, e, b.ColorA, b.ColorB, b.IsBlend));
                }
