...
namespace InfiniteGPS
{
    [Priority(Priority.Normal)]
    [RequiredDependencies("")]
    public class InfiniteGPS : ModBase
    {
        /// <summary>
        /// Entrypoint for the InfiniteTeleportGPS mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public InfiniteGPS() : base("InfiniteGPS", new Version("0.1.0.0"))
        {
        ...
        public override void Start()
        {
            ...
            var ns    = typeof(InfiniteGPS).Namespace;
