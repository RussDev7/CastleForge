...
namespace VoiceChat
{
    ...
    public class VoiceChat : ModBase
    {
        /// <summary>
        /// Entrypoint for the VoiceChat mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public override void Start()
        {
            ...
            var ns    = typeof(VoiceChat).Namespace;
            ...
            VoiceChatConfigStore.LoadOrCreateDefaults();
