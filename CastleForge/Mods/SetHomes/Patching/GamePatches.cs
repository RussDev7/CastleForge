...
namespace SetHomes
{
    ...
    class GamePatches
    {
        ...
        /// // ... each frame (via Harmony patch) -> if (WEHotkeys.ReloadPressedThisFrame()) { SHConfig.LoadApply(); ... }
        ///
        /// EXAMPLES
        /// --------
        /// "F9"                 -> F9.
        ...
        /// </summary>
        internal static class SHHotkeys
        {
        ...
        static class Patch_Hotkey_ReloadConfig_SetHomes
        {
            ...
            {
                if (!SHHotkeys.ReloadPressedThisFrame()) return;
                ...
                try
                {
                    ...
                    SendFeedback($"[SHomes] Config hot-reloaded from \"{PathShortener.ShortenForLog(SHConfig.ConfigPath)}\".");
                }
                catch (Exception ex)
                {
                    SendFeedback($"[SHomes] Hot-reload failed: {ex.Message}.");
                }
            }
        }
        #endregion
