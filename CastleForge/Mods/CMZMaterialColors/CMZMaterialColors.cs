...
namespace CMZMaterialColors
{
    ...
    public class CMZMaterialColors : ModBase
    {
        /// <summary>
        /// Entrypoint for the CMZMaterialColors mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public CMZMaterialColors() : base("CMZMaterialColors", new Version("0.0.1.0"))
        {
        ...
        public override void Start()
        {
            ...
            var ns = typeof(CMZMaterialColors).Namespace;
