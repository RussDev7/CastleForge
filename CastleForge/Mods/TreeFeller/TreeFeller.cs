...
namespace TreeFeller
{
    ...
    public class TreeFeller : ModBase
    {
        /// <summary>
        /// Entrypoint for the TreeFeller mod: Sets up command dispatching, patches, and world lookup.
        /// </summary>
        ...
        public TreeFeller() : base("TreeFeller", new Version("0.0.1"))
        {
        ...
        public override void Start()
        {
            ...
            var ns = typeof(TreeFeller).Namespace;
